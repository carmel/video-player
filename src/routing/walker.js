 ...
 *       Node,
 *       Payload,
 *       Payload):!AbortableOperation,
 *   handleError: function(
 *       Payload,
 *       !Error):!Promise.<Node>,
 *   onIdle: function(Node)
 * }}
 *
 * @description
 ...
 * @property {function(
 *     Payload,
 *     !Error):!Promise.<Node> handleError
 ...
 *   |Walker.Implementation.getNext| to help determine where to
 *   go next.
 *
 * @property {Payload| payload
 *   The payload that the walker should have once it arrives at |node|. This
 *   will be passed to the |Walker.Implementation.getNext| to
 ...
 *   is the union of |Walker.Request_| and the
 *   |Walker.Route| created by |Walker.Request_|.
 *
 * @property {Node} node
 *   The node that the walker should move towards. This will be passed to
 *   |Walker.Implementation.getNext| to help determine where to
 ...
 *   resolving the next request.
 *
 * @property {Walker.Listeners} listeners
 ...
 *
 * @property {
 *     function(Payload):?Walker.Route} create
